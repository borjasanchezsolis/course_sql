...
-- Actualizar o editar
UPDATE employees SET birth_date = '1998-12-04' WHERE id = 2
UPDATE employees SET email = 'johanna@gdas.de' WHERE id = 2
UPDATE employees SET email = 'borja@gdas.de', salary = 35000 WHERE id = 1 --(con RETURNING * opcional)
